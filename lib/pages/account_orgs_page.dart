...
class AccountOrgsPage extends StatefulWidget {
  const AccountOrgsPage({Key? key}) : super(key: key);

  @override
  State<AccountOrgsPage> createState() => _AccountOrgsPageState();
}

class _AccountOrgsPageState extends State<AccountOrgsPage> {
  int role = 0;
                    ...
                    child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: const [Text("Булочная, пекарня",
                                style: TextStyle(
                                    color: Colors.black,
                                    fontWeight: FontWeight.w300,
                                    fontSize: 10,
                                    fontFamily: 'GothamPro'),), Text("Сотрудничество с 10.10.2021",
                                style: TextStyle(
                                    color: Colors.black,
                                    fontWeight: FontWeight.w300,
                                    fontSize: 10,
                            ...
                            Row(
                              children: const [Text("Ворошиловский проспект, 53/22",
                                style: TextStyle(
                                    color: Colors.black,
                            ...
                            const SizedBox(height: 5,),
                            Row(
                              children: const [Text("И.М. Седлак",
                                style: TextStyle(
                                    color: Colors.black,
                                    fontWeight: FontWeight.w600,
                                    fontSize: 20,
